...
/*Tarea Jime: CSS y hace las funciones de Seleccion unica, Multiple */
  ...
  render() {
    ...
    return(
      <>
        ...
        <ModalFooter>
            <Button color="primary" onClick={() => this.opcionMultiple(document.getElementById('MUL').value, document.getElementById('LISTA').value)}>Guardar</Button>
            <Button color="secondary" onClick={() => this.cerrarModal()}>Cancelar</Button>
        </ModalFooter>
        </Modal>
        ...
        <ModalFooter>
            <Button color="primary" onClick={() => this.preguntaArchivo(document.getElementById('ARC').value, document.getElementById('TYPE').value)}>Guardar</Button>
            <Button color="secondary" onClick={() => this.cerrarModal()}>Cancelar</Button>
        </ModalFooter>
        </Modal>
    </>
